(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('react'), require('redux'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'react', 'redux'], factory)
    : ((global = global || self),
      factory((global['video-react'] = {}), global.React, global.Redux));
  ...
  var Video =
    ...
    (function(_Component) {
      ...
      _proto.handleTextTrackChange = function handleTextTrackChange() {
        ...
        if (this.video && this.video.textTracks) {
          var activeTextTrack = Array.from(this.video.textTracks).find(function(
            textTrack
          ) {
