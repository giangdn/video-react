(function(e, t) {
  ...
  function m(e, t) {
    switch ((void 0 === e && (e = tt), t.type)) {
      ...
      case 'video-react/PAUSE':
        return r({}, e, t.videoProps, { paused: !0 });
      case 'video-react/END':
        return r({}, e, t.videoProps, { ended: !0 });
      case 'video-react/SEEKING':
        return r({}, e, t.videoProps, { seeking: !0 });
      case 'video-react/SEEKED':
        return r({}, e, t.videoProps, { seeking: !1 });
      case 'video-react/ERROR':
        return r({}, e, t.videoProps, { error: 'UNKNOWN ERROR', ended: !0 });
      ...
      case 'video-react/ACTIVATE_TEXT_TRACK':
        return r({}, e, { activeTextTrack: t.textTrack });
      default:
        return e;
    }
  }
  function v(e, t) {
    switch ((void 0 === e && (e = at), t.type)) {
      case 'video-react/OPERATE':
        return r({}, e, {
          count: e.count + 1,
          operation: r({}, e.operation, t.operation)
        });
      default:
        return e;
    }
  ...
  function y(e, t) {
    return (
      void 0 === e && (e = {}),
      { player: m(e.player, t), operation: v(e.operation, t) }
    );
  }
  function g(e) {
    var t = e.player,
    ...
    return t.error
      ? null
      : O.createElement('div', {
          className: Xe('video-react-loading-spinner', a)
        });
  }
  function E(e) {
    var t = e.poster,
    ...
    return !t || a.hasStarted
      ? null
      : O.createElement('div', {
          className: Xe('video-react-poster', o),
  ...
  function C(t, a, n, o) {
    ...
    return l
      ...
      .concat(
        t.filter(function(e) {
          return !st(l, function(t) {
            return ct(t, e);
          });
        })
      )
      .map(function(a) {
        var n = st(t, function(e) {
            return ct(e, a);
          }),
          o = n ? n.props : {},
          l = r({}, s, o, a.props),
          d = O.cloneElement(a, l, a.props.children);
        return d;
      })
      .sort(function(e, t) {
  ...
  function M(e) {
    ...
    return O.createElement(
      'div',
      {
        'data-current-time': b(t, a),
        className: Xe('video-react-play-progress video-react-slider-bar', o),
        style: { width: n }
      },
      O.createElement(
        'span',
  ...
  function D(e) {
    ...
    return (
      ...
      O.createElement(
        'div',
        { style: l, className: Xe('video-react-load-progress', o) },
        O.createElement(
          'span',
          { className: 'video-react-control-text' },
          'Loaded: 0%'
  ...
  function w(e) {
    ...
    return O.createElement('div', {
      className: Xe('video-react-mouse-display', n),
  ...
  function F(e) {
    ...
    return O.createElement(
      'div',
      {
        className: Xe('video-react-time-control video-react-time-divider', a),
        dir: 'ltr'
      },
  ...
  function _(e) {
    ...
    return (
      ...
      O.createElement(
        'div',
        { className: Xe(n, 'video-react-volume-level'), style: o },
        O.createElement('span', { className: 'video-react-control-text' })
      )
    );
  }
  var O = 'default' in t ? t['default'] : t,
    B = c(function(a, o) {
      ...
      var s = 'function' == typeof Symbol && Symbol.for,
        ...
        b = s ? Symbol.for('react.lazy') : 60116;
      (o.typeOf = i),
        (o.AsyncMode = E),
        (o.ConcurrentMode = l),
        (o.ContextConsumer = h),
  ...
  var U = B.typeOf,
    ...
    Z = B.StrictMode,
    J = B.Suspense,
    Q = B.isValidElementType,
    ee = B.isAsyncMode,
    te = B.isConcurrentMode,
    ae = B.isContextConsumer,
    ne = B.isContextProvider,
    oe = B.isElement,
    re = B.isForwardRef,
    le = B.isFragment,
    de = B.isLazy,
  ...
  var me = he.typeOf,
    ve = he.AsyncMode,
    ye = he.ConcurrentMode,
    ge = he.ContextConsumer,
    Ee = he.ContextProvider,
    be = he.Element,
    fe = he.ForwardRef,
    Ce = he.Fragment,
    ke = he.Lazy,
    ...
    Ne = he.StrictMode,
    Ae = he.Suspense,
    Me = he.isValidElementType,
    De = he.isAsyncMode,
    we = he.isConcurrentMode,
    Re = he.isContextConsumer,
    xe = he.isContextProvider,
    Ie = he.isElement,
    Fe = he.isForwardRef,
    Le = he.isFragment,
    _e = he.isLazy,
    ...
    We = (function() {
      ...
      ? Object.assign
      : function(e) {
          for (var t, a, n = p(e), o = 1; o < arguments.length; o++) {
            for (var r in ((t = Object(arguments[o])), t))
              Ve.call(t, r) && (n[r] = t[r]);
            if (Ge) {
              a = Ge(t);
              for (var l = 0; l < a.length; l++)
                ze.call(t, a[l]) && (n[a[l]] = t[a[l]]);
            }
          }
          return n;
        },
    Ye = Function.call.bind(Object.prototype.hasOwnProperty);
  h.resetWarningCache = u;
  var qe = function() {
    ...
    et = Object.freeze({
      ...
      toggleFullscreen: function(e) {
        return Qe.enabled
          ? (Qe.isFullscreen ? Qe.exit() : Qe.request(this.rootElement),
            {
    ...
    at = { count: 0, operation: { action: '', source: '' } },
    nt = (function() {
      function e(e) {
        (this.store = e || a.createStore(y)),
          (this.video = null),
    ...
    rt = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.handleClick = n.handleClick.bind(i(n))),
          n
        );
      }
      l(t, e);
  ...
  (rt.propTypes = ot),
    (rt.defaultProps = { position: 'left' }),
    (rt.displayName = 'BigPlayButton');
  var lt = { player: $e.object, className: $e.string };
  (g.propTypes = lt), (g.displayName = 'LoadingSpinner');
  var dt = {
    poster: $e.string,
    player: $e.object,
    actions: $e.object,
  ...
  (E.propTypes = dt), (E.displayName = 'PosterImage');
  var it =
      Number.isNaN ||
      function(e) {
        return e !== e;
    ...
    ut = {
      ...
      poster: $e.string,
      className: $e.string,
      preload: $e.oneOf(['auto', 'metadata', 'none']),
      crossOrigin: $e.string,
      onLoadStart: $e.func,
      onWaiting: $e.func,
      onCanPlay: $e.func,
      onCanPlayThrough: $e.func,
      onPlaying: $e.func,
      onEnded: $e.func,
      onSeeking: $e.func,
      onSeeked: $e.func,
      ...
      onPause: $e.func,
      onProgress: $e.func,
      onDurationChange: $e.func,
      onError: $e.func,
      onSuspend: $e.func,
      onAbort: $e.func,
      onEmptied: $e.func,
      onStalled: $e.func,
      onLoadedMetadata: $e.func,
      onLoadedData: $e.func,
      onTimeUpdate: $e.func,
      onRateChange: $e.func,
      onVolumeChange: $e.func,
      onResize: $e.func
    },
    ht = (function(e) {
      function t(t) {
        ...
        return (
          ...
          (a.handleProgress = T(a.handleProgress.bind(i(a)), 250)),
      ...
      return (
        ...
        (a.renderChildren = function() {
          var e = this,
            t = r({}, this.props, { video: this.video });
          return this.video
        ...
        (a.render = function() {
          ...
          return O.createElement(
            'video',
            {
              className: Xe('video-react-video', this.props.className),
              id: c,
              crossOrigin: s,
              ref: function(t) {
                e.video = t;
  ...
  (ht.propTypes = ut), (ht.displayName = 'Video');
  var mt = { manager: $e.object, className: $e.string },
    vt = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  (vt.propTypes = mt), (vt.displayName = 'Bezel');
  var yt = {
      clickable: $e.bool,
      dblclickable: $e.bool,
      manager: $e.object,
    ...
    gt = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.mergeShortcuts = n.mergeShortcuts.bind(i(n))),
          (n.handleKeyPress = n.handleKeyPress.bind(i(n))),
          (n.handleClick = n.handleClick.bind(i(n))),
          (n.handleDoubleClick = n.handleDoubleClick.bind(i(n))),
          n
        );
      }
      l(t, e);
  ...
  (gt.propTypes = yt),
    (gt.defaultProps = { clickable: !0, dblclickable: !0 }),
    (gt.displayName = 'Shortcut');
  var Et = {
      className: $e.string,
      onMouseDown: $e.func,
      onMouseMove: $e.func,
    ...
    bt = (function(e) {
      function t(t, a) {
        ...
        return (
          (n = e.call(this, t, a) || this),
          (n.handleMouseDown = n.handleMouseDown.bind(i(n))),
          (n.handleMouseMove = n.handleMouseMove.bind(i(n))),
          (n.handleMouseUp = n.handleMouseUp.bind(i(n))),
          (n.handleFocus = n.handleFocus.bind(i(n))),
          (n.handleBlur = n.handleBlur.bind(i(n))),
          (n.handleClick = n.handleClick.bind(i(n))),
          (n.handleKeyPress = n.handleKeyPress.bind(i(n))),
          (n.stepForward = n.stepForward.bind(i(n))),
          (n.stepBack = n.stepBack.bind(i(n))),
          (n.calculateDistance = n.calculateDistance.bind(i(n))),
          (n.getProgress = n.getProgress.bind(i(n))),
          (n.renderChildren = n.renderChildren.bind(i(n))),
          (n.state = { active: !1 }),
          n
        );
      }
      ...
      return (
        ...
        (a.renderChildren = function() {
          var e = this.getProgress(),
            t = (100 * e).toFixed(2) + '%';
          return O.Children.map(this.props.children, function(a) {
            return O.cloneElement(a, { progress: e, percentage: t });
          });
        }),
        (a.render = function() {
          var e = this,
  ...
  (bt.propTypes = Et), (bt.displayName = 'Slider');
  var ft = {
  ...
  (M.propTypes = ft), (M.displayName = 'PlayProgressBar');
  var Ct = { duration: $e.number, buffered: $e.object, className: $e.string };
  (D.propTypes = Ct),
    (D.displayName = 'LoadProgressBar'),
    (w.propTypes = {
      duration: $e.number,
      mouseTime: $e.object,
      className: $e.string
    }),
    (w.displayName = 'MouseTimeDisplay');
  var kt = {
      player: $e.object,
      mouseTime: $e.object,
      actions: $e.object,
    ...
    Tt = (function(e) {
      function t(t, a) {
        ...
        return (
          (n = e.call(this, t, a) || this),
          (n.getPercent = n.getPercent.bind(i(n))),
          (n.getNewTime = n.getNewTime.bind(i(n))),
          (n.stepForward = n.stepForward.bind(i(n))),
          (n.stepBack = n.stepBack.bind(i(n))),
          (n.handleMouseDown = n.handleMouseDown.bind(i(n))),
          (n.handleMouseMove = n.handleMouseMove.bind(i(n))),
      ...
      return (
        ...
        (a.render = function() {
          ...
          return O.createElement(
            ...
            O.createElement(D, { buffered: l, currentTime: i, duration: r }),
            O.createElement(w, { duration: r, mouseTime: d }),
            O.createElement(M, { currentTime: i, duration: r })
          );
        }),
        t
      );
    })(t.Component);
  (Tt.propTypes = kt), (Tt.displayName = 'SeekBar');
  var Pt = { player: $e.object, className: $e.string },
    St = (function(e) {
      function t(t, a) {
        var n;
        return (
          ...
          (n.handleMouseMoveThrottle = n.handleMouseMove.bind(i(n))),
          n
        );
      }
      l(t, e);
  ...
  (St.propTypes = Pt), (St.displayName = 'ProgressControl');
  var Nt = { actions: $e.object, player: $e.object, className: $e.string },
    At = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  (At.propTypes = Nt), (At.displayName = 'PlayToggle');
  var Mt = {
      actions: $e.object,
      className: $e.string,
      seconds: $e.oneOf([5, 10, 30])
    },
    Dt = { seconds: 10 },
    wt = function(e) {
      var a = (function(t) {
      ...
      return (a.propTypes = Mt), (a.defaultProps = Dt), a;
    },
    Rt = wt('forward');
  Rt.displayName = 'ForwardControl';
  var xt = wt('replay');
  xt.displayName = 'ReplayControl';
  var It = { actions: $e.object, player: $e.object, className: $e.string },
    Ft = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  (Ft.propTypes = It), (Ft.displayName = 'FullscreenToggle');
  var Lt = { player: $e.object, className: $e.string };
  (R.propTypes = Lt), (R.displayName = 'RemainingTimeDisplay');
  var _t = { player: $e.object, className: $e.string };
  (x.propTypes = _t), (x.displayName = 'CurrentTimeDisplay');
  var Ot = { player: $e.object, className: $e.string };
  (I.propTypes = Ot), (I.displayName = 'DurationDisplay');
  var Bt = { separator: $e.string, className: $e.string };
  (F.propTypes = Bt), (F.displayName = 'TimeDivider');
  var Ut = {
      tagName: $e.string,
        ...
        (a.render = function() {
          ...
          return (
            ...
            O.createElement(
              ...
              r(
                {
                  className: Xe(this.props.className),
                  role: 'button',
                  tabIndex: '0',
                  onClick: this.handleClick,
                  onFocus: this.handleFocus,
  ...
  (Kt.propTypes = Ut),
    (Kt.defaultProps = { tagName: 'div' }),
    (Kt.displayName = 'ClickableComponent');
  var jt = { player: $e.object, children: $e.any },
    Ht = (function(e) {
      function t(t, a) {
        var n;
        return (
      ...
      return (
        ...
        (a.render = function() {
          ...
          return O.createElement(
            ...
            O.createElement('div', { className: 'video-react-menu-content' }, e)
          );
        }),
        t
      );
    })(t.Component);
  (Ht.propTypes = jt), (Ht.displayName = 'Popup');
  var Gt = {
    inline: $e.bool,
    onClick: $e.func.isRequired,
    onFocus: $e.func,
  ...
  (L.propTypes = Gt),
    (L.defaultProps = { inline: !0 }),
    (L.displayName = 'PopupButton');
  var Vt = { percentage: $e.string, vertical: $e.bool, className: $e.string };
  (_.propTypes = Vt),
    (_.defaultProps = { percentage: '100%', vertical: !1 }),
    (_.displayName = 'VolumeLevel');
  var zt = {
      actions: $e.object,
      player: $e.object,
      className: $e.string,
    ...
    Wt = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.handleMouseMove = n.handleMouseMove.bind(i(n))),
          (n.handlePercentageChange = n.handlePercentageChange.bind(i(n))),
          (n.checkMuted = n.checkMuted.bind(i(n))),
          (n.getPercent = n.getPercent.bind(i(n))),
          (n.stepForward = n.stepForward.bind(i(n))),
          (n.stepBack = n.stepBack.bind(i(n))),
          (n.handleFocus = n.handleFocus.bind(i(n))),
      ...
      return (
        ...
        (a.render = function() {
          ...
          return O.createElement(
            ...
            O.createElement(_, this.props)
          );
        }),
        t
      );
    })(t.Component);
  (Wt.propTypes = zt), (Wt.displayName = 'VolumeBar');
  var Yt = {
      player: $e.object,
      actions: $e.object,
      vertical: $e.bool,
      className: $e.string,
      alwaysShowVolume: $e.bool
    },
    qt = (function(e) {
      function t(t, a) {
        var n;
  ...
  (qt.propTypes = Yt),
    (qt.defaultProps = { vertical: !1 }),
    (qt.displayName = 'VolumeMenuButton');
  var $t = { children: $e.any },
    Xt = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  (Xt.propTypes = $t), (Xt.displayName = 'Menu');
  var Zt = {
      item: $e.object,
      index: $e.number,
      activateIndex: $e.number,
      onSelectItem: $e.func
    },
    Jt = (function(e) {
      function t(t, a) {
  ...
  (Jt.propTypes = Zt), (Jt.displayName = 'MenuItem');
  var Qt = {
      inline: $e.bool,
      items: $e.array,
      className: $e.string,
    ...
    ea = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.commitSelection = n.commitSelection.bind(i(n))),
          (n.activateMenuItem = n.activateMenuItem.bind(i(n))),
          (n.handleClick = n.handleClick.bind(i(n))),
          (n.renderMenu = n.renderMenu.bind(i(n))),
          (n.handleFocus = n.handleFocus.bind(i(n))),
          (n.handleBlur = n.handleBlur.bind(i(n))),
          (n.handleUpArrow = n.handleUpArrow.bind(i(n))),
          (n.handleDownArrow = n.handleDownArrow.bind(i(n))),
          (n.handleEscape = n.handleEscape.bind(i(n))),
          (n.handleReturn = n.handleReturn.bind(i(n))),
          (n.handleTab = n.handleTab.bind(i(n))),
          (n.handleKeyPress = n.handleKeyPress.bind(i(n))),
          (n.handleSelectItem = n.handleSelectItem.bind(i(n))),
          (n.handleIndexChange = n.handleIndexChange.bind(i(n))),
          n
        );
      }
      l(t, e);
  ...
  (ea.propTypes = Qt), (ea.displayName = 'MenuButton');
  var ta = {
      player: $e.object,
      actions: $e.object,
      rates: $e.array,
      ...
      return (
        ...
        (a.render = function() {
          ...
          return O.createElement(
            ea,
            {
              className: Xe('video-react-playback-rate', this.props.className),
  ...
  var na = {
      children: $e.any,
      autoHide: $e.bool,
      autoHideTime: $e.number,
      disableDefaultControls: $e.bool,
      disableCompletely: $e.bool,
      className: $e.string
    },
    oa = (function(e) {
      function t(t) {
      ...
      return (
        (a.getDefaultChildren = function() {
          return [
            O.createElement(At, { key: 'play-toggle', order: 1 }),
            O.createElement(qt, { key: 'volume-menu-button', order: 4 }),
            O.createElement(x, { key: 'current-time-display', order: 5.1 }),
            O.createElement(F, { key: 'time-divider', order: 5.2 }),
            O.createElement(I, { key: 'duration-display', order: 5.3 }),
            O.createElement(St, { key: 'progress-control', order: 6 }),
            O.createElement(Ft, { key: 'fullscreen-toggle', order: 8 })
          ];
        }),
        (a.getFullChildren = function() {
          return [
            O.createElement(At, { key: 'play-toggle', order: 1 }),
            O.createElement(xt, { key: 'replay-control', order: 2 }),
            O.createElement(Rt, { key: 'forward-control', order: 3 }),
            O.createElement(qt, { key: 'volume-menu-button', order: 4 }),
            O.createElement(x, { key: 'current-time-display', order: 5 }),
            O.createElement(F, { key: 'time-divider', order: 6 }),
            O.createElement(I, { key: 'duration-display', order: 7 }),
            O.createElement(St, { key: 'progress-control', order: 8 }),
            O.createElement(R, { key: 'remaining-time-display', order: 9 }),
            O.createElement(aa, {
              rates: [1, 1.25, 1.5, 2],
              key: 'playback-rate',
              order: 10
            }),
            O.createElement(Ft, { key: 'fullscreen-toggle', order: 11 })
          ];
        }),
  ...
  (oa.propTypes = na),
    (oa.defaultProps = { autoHide: !0, disableCompletely: !1 }),
    (oa.displayName = 'ControlBar');
  var ra =
      'undefined' != typeof window && window.navigator
        ? window.navigator.userAgent
        : '',
    la = /iPad/i.test(ra),
    da = /iPhone/i.test(ra) && !la,
    ia = /iPod/i.test(ra),
    sa = {
      children: $e.any,
    ...
    ca = (function(e) {
      function t(t) {
        ...
        return (
          ...
          (a.handleMouseMove = T(a.handleMouseMove.bind(i(a)), 250)),
      ...
      return (
        (a.componentDidMount = function() {
          this.handleResize(),
            ...
            Qe.addEventListener(this.handleFullScreenChange);
        }),
        (a.componentWillUnmount = function() {
          window.removeEventListener('resize', this.handleResize),
            Qe.removeEventListener(this.handleFullScreenChange),
        ...
        (a.getDefaultChildren = function(e) {
          ...
          return [
            ...
            O.createElement(E, { key: 'poster-image', order: 1 }),
            O.createElement(g, { key: 'loading-spinner', order: 2 }),
            O.createElement(vt, { key: 'bezel', order: 3 }),
            O.createElement(rt, { key: 'big-play-button', order: 4 }),
            O.createElement(oa, { key: 'control-bar', order: 5 }),
            O.createElement(gt, { key: 'shortcut', order: 99 })
          ];
        }),
        (a.getChildren = function(e) {
          var t = e.className,
            ...
            o = O.Children.toArray(this.props.children).filter(function(t) {
              return !f(t);
            }),
        ...
        (a.handleFullScreenChange = function(e) {
          e.target === this.manager.rootElement &&
            this.actions.handleFullscreenChange(Qe.isFullscreen);
        }),
        (a.handleMouseDown = function() {
        ...
        (a.startControlsTimer = function() {
          var e = this,
            t = 3e3;
          O.Children.forEach(this.props.children, function(e) {
            if (O.isValidElement(e) && e.type === oa) {
        ...
        (a.handleStateChange = function(e, t) {
          e.isFullscreen !== t.isFullscreen &&
            (this.handleResize(), N(this.manager.rootElement)),
            this.forceUpdate();
        }),
        (a.handleFocus = function() {
              ...
              className: Xe(
                {
                  ...
                  'video-react-workinghover': !(da || la || ia)
                },
                'video-react',
                this.props.className
              ),
  ...
  (ca.contextTypes = { store: $e.object }),
    (ca.propTypes = sa),
    (ca.defaultProps = {
      fluid: !0,
      muted: !1,
  ...
  var pa = (function(e) {
    ...
    return (
      (a.render = function() {
        return O.createElement(aa, this.props);
      }),
      t
    );
  })(t.Component);
  ...
  var ua = {
    ...
    ha = (function(e) {
      function t(t, a) {
        ...
        return (
          (n = e.call(this, t, a) || this),
          (n.getTextTrackItems = n.getTextTrackItems.bind(i(n))),
          (n.updateState = n.updateState.bind(i(n))),
          (n.handleSelectItem = n.handleSelectItem.bind(i(n))),
      ...
      return (
        ...
        (a.render = function() {
          ...
          return O.createElement(
            ea,
            {
              className: Xe('video-react-closed-caption', this.props.className),
              onSelectItem: this.handleSelectItem,
              items: t,
              selectedIndex: a
            },
  ...
  (ha.propTypes = ua),
    ...
    (ha.displayName = 'ClosedCaptionButton'),
    (e.Bezel = vt),
    (e.BigPlayButton = rt),
    (e.ClosedCaptionButton = ha),
    (e.ControlBar = oa),
    (e.CurrentTimeDisplay = x),
    (e.DurationDisplay = I),
    (e.ForwardControl = Rt),
    (e.FullscreenToggle = Ft),
    (e.LoadProgressBar = D),
    (e.LoadingSpinner = g),
    (e.MenuButton = ea),
    (e.MouseTimeDisplay = w),
    (e.PlayProgressBar = M),
    (e.PlayToggle = At),
    (e.PlaybackRate = pa),
    ...
    (e.Player = ca),
    (e.PosterImage = E),
    (e.ProgressControl = St),
    (e.RemainingTimeDisplay = R),
    (e.ReplayControl = xt),
    (e.SeekBar = Tt),
    (e.Shortcut = gt),
    (e.Slider = bt),
    (e.TimeDivider = F),
    (e.Video = ht),
    (e.VolumeMenuButton = qt),
    (e.operationReducer = v),
    (e.playerActions = et),
    (e.playerReducer = m),
    (e.videoActions = Ze),
