(function(e, t) {
  ...
  function v(e, t, a) {
    ...
    function l(e) {
      ...
      for (var t, a = (c = p), n = 0; n < a.length; n++) (t = a[n]), t();
      return e;
    }
    var d;
    if (
  ...
  function b(e, t) {
    return (
      void 0 === e && (e = {}),
      { player: y(e.player, t), operation: g(e.operation, t) }
    );
  }
  function E(e) {
    var t = e.player,
    ...
    return t.error
      ? null
      : U.createElement('div', {
          className: Qe('video-react-loading-spinner', a)
        });
  }
  function f(e) {
    var t = e.poster,
    ...
    return !t || a.hasStarted
      ? null
      : U.createElement('div', {
          className: Qe('video-react-poster', o),
  ...
  function T(t, a, n, r) {
    ...
    return d
      ...
      .concat(
        t.filter(function(e) {
          return !vt(d, function(t) {
            return yt(t, e);
          });
        })
      )
      .map(function(a) {
        var n = vt(t, function(e) {
            return yt(e, a);
          }),
          r = n ? n.props : {},
          l = o({}, s, r, a.props),
          d = U.cloneElement(a, l, a.props.children);
        return d;
      })
      .sort(function(e, t) {
  ...
  function A(e, t) {
    ...
    return (
      t.changedTouches &&
        ((p = t.changedTouches[0].pageX), (c = t.changedTouches[0].pageY)),
      (o.y = a(0, n(1, (i - c + d) / d))),
      (o.x = a(0, n(1, (p - s) / l))),
      o
    );
  ...
  function D(e) {
    ...
    return U.createElement(
      'div',
      {
        'data-current-time': C(t, a),
        className: Qe('video-react-play-progress video-react-slider-bar', o),
        style: { width: n }
      },
      U.createElement(
        'span',
  ...
  function R(e) {
    ...
    var r = a.end(a.length - 1),
      l = {};
    r > n && (r = n), (l.width = t(r, n));
    for (var d = [], s = 0; s < a.length; s++) {
      var c = a.start(s),
        p = a.end(s),
        u = U.createElement('div', {
          style: { left: t(c, r), width: t(p - c, r) },
          key: 'part-' + s
        });
      d.push(u);
    }
    return (
      ...
      U.createElement(
        'div',
        { style: l, className: Qe('video-react-load-progress', o) },
        U.createElement(
          'span',
          { className: 'video-react-control-text' },
          'Loaded: 0%'
  ...
  function x(e) {
    ...
    return U.createElement('div', {
      className: Qe('video-react-mouse-display', n),
  ...
  function O(e) {
    ...
    return U.createElement(
      'div',
      {
        className: Qe('video-react-time-control video-react-time-divider', a),
        dir: 'ltr'
      },
      U.createElement('div', null, U.createElement('span', null, t || '/'))
    );
  }
  function _(e) {
    var t = e.inline,
  ...
  function B(e) {
    var t = e.percentage,
      ...
      o = {};
    return (
      a ? (o.height = t) : (o.width = t),
      U.createElement(
        'div',
        { className: Qe(n, 'video-react-volume-level'), style: o },
  ...
  var U = 'default' in t ? t['default'] : t,
    j = s(function(a, o) {
      ...
      var s = 'function' == typeof Symbol && Symbol.for,
        v = s ? Symbol.for('react.element') : 60103,
        c = s ? Symbol.for('react.portal') : 60106,
        d = s ? Symbol.for('react.fragment') : 60107,
        e = s ? Symbol.for('react.strict_mode') : 60108,
        y = s ? Symbol.for('react.profiler') : 60114,
        g = s ? Symbol.for('react.provider') : 60109,
        h = s ? Symbol.for('react.context') : 60110,
        b = s ? Symbol.for('react.async_mode') : 60111,
        l = s ? Symbol.for('react.concurrent_mode') : 60111,
        m = s ? Symbol.for('react.forward_ref') : 60112,
        n = s ? Symbol.for('react.suspense') : 60113,
  ...
  var K = j.typeOf,
    ...
    Q = j.StrictMode,
    ee = j.Suspense,
    te = j.isValidElementType,
    ae = j.isAsyncMode,
    ne = j.isConcurrentMode,
    oe = j.isContextConsumer,
    re = j.isContextProvider,
    le = j.isElement,
    de = j.isForwardRef,
    ie = j.isFragment,
    se = j.isLazy,
  ...
  var ye = ve.typeOf,
    ge = ve.AsyncMode,
    be = ve.ConcurrentMode,
    Ee = ve.ContextConsumer,
    fe = ve.ContextProvider,
    Ce = ve.Element,
    ke = ve.ForwardRef,
    Te = ve.Fragment,
    Pe = ve.Lazy,
    ...
    Me = ve.StrictMode,
    we = ve.Suspense,
    De = ve.isValidElementType,
    Re = ve.isAsyncMode,
    xe = ve.isConcurrentMode,
    Ie = ve.isContextConsumer,
    Fe = ve.isContextProvider,
    Le = ve.isElement,
    Oe = ve.isForwardRef,
    _e = ve.isFragment,
    Be = ve.isLazy,
    ...
    qe = (function() {
      ...
      try {
        ...
        if (((t[5] = 'de'), '5' === Object.getOwnPropertyNames(t)[0]))
          return !1;
        for (var a = {}, n = 0; 10 > n; n++) a['_' + e(n)] = n;
        var o = Object.getOwnPropertyNames(a).map(function(e) {
          return a[e];
        });
      ...
      ? Object.assign
      : function(e) {
          for (var t, a, n = c(e), o = 1; o < arguments.length; o++) {
          ...
          for (var e, n = [], o = 0; o < arguments.length; o++)
            if (((e = arguments[o]), e)) {
              ...
              if ('string' === r || 'number' === r) n.push(e);
                ...
                for (var d in e) a.call(e, d) && e[d] && n.push(d);
            }
          return n.join(' ');
        }
  ...
  var et = h(Xe),
    ...
    lt = Object.freeze({
      ...
      toggleFullscreen: function(e) {
        return rt.enabled
          ? (rt.isFullscreen ? rt.exit() : rt.request(this.rootElement),
            {
    ...
    it = { count: 0, operation: { action: '', source: '' } },
    st = (function() {
      function e(e) {
        (this.store = e || v(b)),
          (this.video = null),
      ...
      var t = e.prototype;
      return (
        (t.getActions = function() {
          function e(e) {
            return function() {
              var n = e.apply(t, arguments);
              'undefined' != typeof n && a(n);
            };
          }
          var t = this,
        ...
        (t.subscribeToOperationStateChange = function(e) {
          var t = this;
          return this.subscribeToStateChange(e, function() {
            return t.getState().operation;
          });
        }),
        (t.subscribeToPlayerStateChange = function(e) {
          var t = this;
          return this.subscribeToStateChange(e, function() {
  ...
  (pt.propTypes = ct),
    (pt.defaultProps = { position: 'left' }),
    (pt.displayName = 'BigPlayButton');
  ...
  var mt =
    ...
    yt = function(e, t) {
      ...
      return 'string' == typeof a || 'string' == typeof n
        ? a === n
        : !('function' != typeof a || 'function' != typeof n) &&
    ...
    bt = {
      ...
      poster: Je.string,
      className: Je.string,
      preload: Je.oneOf(['auto', 'metadata', 'none']),
      crossOrigin: Je.string,
      onLoadStart: Je.func,
      onWaiting: Je.func,
      onCanPlay: Je.func,
      onCanPlayThrough: Je.func,
      onPlaying: Je.func,
      onEnded: Je.func,
      onSeeking: Je.func,
      onSeeked: Je.func,
      ...
      onPause: Je.func,
      onProgress: Je.func,
      onDurationChange: Je.func,
      onError: Je.func,
      onSuspend: Je.func,
      onAbort: Je.func,
      onEmptied: Je.func,
      onStalled: Je.func,
      onLoadedMetadata: Je.func,
      onLoadedData: Je.func,
      onTimeUpdate: Je.func,
      onRateChange: Je.func,
      onVolumeChange: Je.func,
      onResize: Je.func
    },
    Et = (function(e) {
      function t(t) {
        ...
        return (
          ...
          (a.video = null),
          (a.play = a.play.bind(d(a))),
          (a.pause = a.pause.bind(d(a))),
          (a.seek = a.seek.bind(d(a))),
          (a.forward = a.forward.bind(d(a))),
          (a.replay = a.replay.bind(d(a))),
          (a.toggleFullscreen = a.toggleFullscreen.bind(d(a))),
          (a.getProperties = a.getProperties.bind(d(a))),
          (a.renderChildren = a.renderChildren.bind(d(a))),
          (a.handleLoadStart = a.handleLoadStart.bind(d(a))),
          (a.handleCanPlay = a.handleCanPlay.bind(d(a))),
          (a.handleCanPlayThrough = a.handleCanPlayThrough.bind(d(a))),
          (a.handlePlay = a.handlePlay.bind(d(a))),
          (a.handlePlaying = a.handlePlaying.bind(d(a))),
          (a.handlePause = a.handlePause.bind(d(a))),
          (a.handleEnded = a.handleEnded.bind(d(a))),
          (a.handleWaiting = a.handleWaiting.bind(d(a))),
          (a.handleSeeking = a.handleSeeking.bind(d(a))),
          (a.handleSeeked = a.handleSeeked.bind(d(a))),
          (a.handleFullscreenChange = a.handleFullscreenChange.bind(d(a))),
          (a.handleError = a.handleError.bind(d(a))),
          (a.handleSuspend = a.handleSuspend.bind(d(a))),
          (a.handleAbort = a.handleAbort.bind(d(a))),
          (a.handleEmptied = a.handleEmptied.bind(d(a))),
          (a.handleStalled = a.handleStalled.bind(d(a))),
          (a.handleLoadedMetaData = a.handleLoadedMetaData.bind(d(a))),
          (a.handleLoadedData = a.handleLoadedData.bind(d(a))),
          (a.handleTimeUpdate = a.handleTimeUpdate.bind(d(a))),
          (a.handleRateChange = a.handleRateChange.bind(d(a))),
          (a.handleVolumeChange = a.handleVolumeChange.bind(d(a))),
          (a.handleDurationChange = a.handleDurationChange.bind(d(a))),
          (a.handleProgress = S(a.handleProgress.bind(d(a)), 250)),
          (a.handleKeypress = a.handleKeypress.bind(d(a))),
          (a.handleTextTrackChange = a.handleTextTrackChange.bind(d(a))),
          a
        );
      }
      r(t, e);
      ...
      return (
        ...
        (a.getProperties = function() {
          var e = this;
          return this.video
            ? gt.reduce(function(t, a) {
                return (t[a] = e.video[a]), t;
              }, {})
            : null;
        }),
        (a.handleTextTrackChange = function() {
          var e = this.props,
            t = e.actions,
            a = e.player;
        ...
        (a.addTextTrack = function() {
          var e;
          (e = this.video).addTextTrack.apply(e, arguments);
        }),
        (a.canPlayType = function() {
          var e;
        ...
        (a.handleCanPlayThrough = function() {
          var e = this.props,
            t = e.actions,
        ...
        (a.handlePlay = function() {
          var e = this.props,
            t = e.actions,
            a = e.onPlay;
          t.handlePlay(this.getProperties()), a && a.apply(void 0, arguments);
        }),
        (a.handlePause = function() {
          var e = this.props,
            t = e.actions,
            a = e.onPause;
          t.handlePause(this.getProperties()), a && a.apply(void 0, arguments);
        }),
        (a.handleDurationChange = function() {
          var e = this.props,
            t = e.actions,
        ...
        (a.handleSeeked = function() {
          var e = this.props,
            t = e.actions,
            a = e.onSeeked;
          t.handleSeeked(this.getProperties()), a && a.apply(void 0, arguments);
        }),
        (a.handleFullscreenChange = function() {}),
        (a.handleSuspend = function() {
          var e = this.props,
            t = e.actions,
            a = e.onSuspend;
        ...
        (a.handleAbort = function() {
          var e = this.props,
            t = e.actions,
            a = e.onAbort;
          t.handleAbort(this.getProperties()), a && a.apply(void 0, arguments);
        }),
        (a.handleEmptied = function() {
          var e = this.props,
            t = e.actions,
            a = e.onEmptied;
        ...
        (a.handleLoadedMetaData = function() {
          var e = this.props,
            t = e.actions,
        ...
        (a.handleError = function() {
          var e = this.props,
            t = e.actions,
            a = e.onError;
          t.handleError(this.getProperties()), a && a.apply(void 0, arguments);
        }),
        (a.handleResize = function() {
          var e = this.props,
            t = e.actions,
            a = e.onResize;
          t.handleResize(this.getProperties()), a && a.apply(void 0, arguments);
        }),
        (a.handleKeypress = function() {}),
        (a.renderChildren = function() {
          var e = this,
            t = o({}, this.props, { video: this.video });
          return this.video
            ? U.Children.toArray(this.props.children)
                .filter(k)
                .map(function(a) {
                  var n;
                  if ('string' != typeof a.type) n = t;
        ...
        (a.render = function() {
          ...
          return U.createElement(
            'video',
            {
              className: Qe('video-react-video', this.props.className),
              id: c,
              crossOrigin: s,
              ref: function(t) {
                e.video = t;
  ...
  var ft = { manager: Je.object, className: Je.string },
    Ct = (function(e) {
      function t(t, a) {
        var n;
        return (
      ...
      var a = t.prototype;
      return (
        (a.handleStateChange = function(e, t) {
          var a = this;
          e.count !== t.count &&
    ...
    Tt = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.defaultShortcuts = [
            ...
            },
            {
              ...
              handle: function(e, t) {
                var a = e.volume - 0.05;
                0 > a && (a = 0);
                var n = 0 < a ? 'volume-down' : 'volume-off';
          ...
          (n.mergeShortcuts = n.mergeShortcuts.bind(d(n))),
          (n.handleKeyPress = n.handleKeyPress.bind(d(n))),
          (n.handleClick = n.handleClick.bind(d(n))),
          (n.handleDoubleClick = n.handleDoubleClick.bind(d(n))),
          n
        );
      }
      r(t, e);
      ...
      return (
        ...
        (a.mergeShortcuts = function() {
          var e = function(e) {
            ...
            t = this.defaultShortcuts.reduce(function(t, a) {
              var n;
              return Object.assign(t, ((n = {}), (n[e(a)] = a), n));
            }, {}),
        ...
        (a.handleKeyPress = function(t) {
          ...
          if (
            ...
            !(
              ...
              (w(document.activeElement, 'video-react-control') ||
                w(document.activeElement, 'video-react-menu-button-active') ||
                w(document.activeElement, 'video-react-big-play-button'))
            )
          ) {
        ...
        (a.handleClick = function(t) {
          var e = this.props,
            ...
            n = e.actions,
            o = e.clickable;
          this.canBeClicked(a, t) && o && this.togglePlay(a, n);
        }),
        (a.handleDoubleClick = function(t) {
          var e = this.props,
            a = e.player,
            n = e.actions,
            o = e.dblclickable;
          this.canBeClicked(a, t) && o && this.toggleFullscreen(a, n);
        }),
        (a.render = function() {
          return null;
        }),
  ...
  (Tt.propTypes = kt),
    (Tt.defaultProps = { clickable: !0, dblclickable: !0 }),
    (Tt.displayName = 'Shortcut');
  var Pt = {
      className: Je.string,
      onMouseDown: Je.func,
      onMouseMove: Je.func,
      stepForward: Je.func,
      stepBack: Je.func,
      sliderActive: Je.func,
      sliderInactive: Je.func,
      onMouseUp: Je.func,
      onFocus: Je.func,
      onBlur: Je.func,
      onClick: Je.func,
    ...
    St = (function(e) {
      function t(t, a) {
        ...
        return (
          (n = e.call(this, t, a) || this),
          (n.handleMouseDown = n.handleMouseDown.bind(d(n))),
          (n.handleMouseMove = n.handleMouseMove.bind(d(n))),
          (n.handleMouseUp = n.handleMouseUp.bind(d(n))),
          (n.handleFocus = n.handleFocus.bind(d(n))),
          (n.handleBlur = n.handleBlur.bind(d(n))),
          (n.handleClick = n.handleClick.bind(d(n))),
          (n.handleKeyPress = n.handleKeyPress.bind(d(n))),
          (n.stepForward = n.stepForward.bind(d(n))),
          (n.stepBack = n.stepBack.bind(d(n))),
          (n.calculateDistance = n.calculateDistance.bind(d(n))),
          (n.getProgress = n.getProgress.bind(d(n))),
          (n.renderChildren = n.renderChildren.bind(d(n))),
          (n.state = { active: !1 }),
          n
        );
      }
      ...
      return (
        ...
        (a.getProgress = function() {
          ...
          if (!e) return 0;
          var t = e();
          return ('number' != typeof t || 0 > t || t === 1 / 0) && (t = 0), t;
        }),
        ...
        (a.calculateDistance = function(e) {
          var t = this.slider,
            a = A(t, e);
        ...
        (a.renderChildren = function() {
          var e = this.getProgress(),
            t = (100 * e).toFixed(2) + '%';
          return U.Children.map(this.props.children, function(a) {
            return U.cloneElement(a, { progress: e, percentage: t });
          });
        }),
        (a.render = function() {
          var e = this,
  ...
  var Mt = {
    ...
    wt = (function(e) {
      function t(t, a) {
        ...
        return (
          (n = e.call(this, t, a) || this),
          (n.getPercent = n.getPercent.bind(d(n))),
          (n.getNewTime = n.getNewTime.bind(d(n))),
          (n.stepForward = n.stepForward.bind(d(n))),
          (n.stepBack = n.stepBack.bind(d(n))),
          (n.handleMouseDown = n.handleMouseDown.bind(d(n))),
          (n.handleMouseMove = n.handleMouseMove.bind(d(n))),
      ...
      return (
        ...
        (a.render = function() {
          ...
          return U.createElement(
            ...
            U.createElement(R, { buffered: l, currentTime: i, duration: r }),
            U.createElement(x, { duration: r, mouseTime: d }),
  ...
  var Dt = { player: Je.object, className: Je.string },
    Rt = (function(e) {
      function t(t, a) {
        var n;
        return (
          ...
          (n.handleMouseMoveThrottle = n.handleMouseMove.bind(d(n))),
          n
        );
      }
      r(t, e);
  ...
  var xt = { actions: Je.object, player: Je.object, className: Je.string },
    It = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  var Ft = {
    ...
    Ot = function(e) {
      ...
      return (a.propTypes = Ft), (a.defaultProps = Lt), a;
    },
    _t = Ot('forward');
  _t.displayName = 'ForwardControl';
  var Bt = Ot('replay');
  Bt.displayName = 'ReplayControl';
  var Ut = { actions: Je.object, player: Je.object, className: Je.string },
    jt = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  var zt = {
    ...
    Wt = (function(e) {
      ...
      var a = t.prototype;
      return (
        (a.componentWillUnmount = function(t) {
          this.handleBlur(t);
        }),
        (a.handleKeypress = function(e) {
        ...
        (a.render = function() {
          ...
          return (
            ...
            U.createElement(
              ...
              o(
                {
                  className: Qe(this.props.className),
                  role: 'button',
                  tabIndex: '0',
                  onClick: this.handleClick,
                  onFocus: this.handleFocus,
  ...
  (Wt.propTypes = zt),
    (Wt.defaultProps = { tagName: 'div' }),
    (Wt.displayName = 'ClickableComponent');
  var Yt = { player: Je.object, children: Je.any },
    qt = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  (_.propTypes = $t),
    (_.defaultProps = { inline: !0 }),
    (_.displayName = 'PopupButton');
  var Xt = { percentage: Je.string, vertical: Je.bool, className: Je.string };
  (B.propTypes = Xt),
    (B.defaultProps = { percentage: '100%', vertical: !1 }),
    (B.displayName = 'VolumeLevel');
  var Zt = {
      actions: Je.object,
      player: Je.object,
      className: Je.string,
    ...
    Jt = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.handleMouseMove = n.handleMouseMove.bind(d(n))),
          (n.handlePercentageChange = n.handlePercentageChange.bind(d(n))),
          (n.checkMuted = n.checkMuted.bind(d(n))),
          (n.getPercent = n.getPercent.bind(d(n))),
          (n.stepForward = n.stepForward.bind(d(n))),
          (n.stepBack = n.stepBack.bind(d(n))),
          (n.handleFocus = n.handleFocus.bind(d(n))),
      ...
      return (
        ...
        (a.handlePercentageChange = function(e) {
            ...
            _,
            {
              className: Qe(
                n,
                {
                  ...
                  'video-react-vol-0': 0 === r && !a.muted,
                  'video-react-vol-1': 1 === r,
                  'video-react-vol-2': 2 === r,
                  'video-react-vol-3': 3 === r,
  ...
  (ea.propTypes = Qt),
    (ea.defaultProps = { vertical: !1 }),
    (ea.displayName = 'VolumeMenuButton');
  var ta = { children: Je.any },
    aa = (function(e) {
      function t(t, a) {
        var n;
        return (
  ...
  var na = {
      item: Je.object,
      index: Je.number,
      activateIndex: Je.number,
      onSelectItem: Je.func
    },
    oa = (function(e) {
      function t(t, a) {
        var n;
    ...
    la = (function(e) {
      function t(t, a) {
        ...
        return (
          ...
          (n.commitSelection = n.commitSelection.bind(d(n))),
          (n.activateMenuItem = n.activateMenuItem.bind(d(n))),
          (n.handleClick = n.handleClick.bind(d(n))),
          (n.renderMenu = n.renderMenu.bind(d(n))),
          (n.handleFocus = n.handleFocus.bind(d(n))),
          (n.handleBlur = n.handleBlur.bind(d(n))),
          (n.handleUpArrow = n.handleUpArrow.bind(d(n))),
          (n.handleDownArrow = n.handleDownArrow.bind(d(n))),
          (n.handleEscape = n.handleEscape.bind(d(n))),
          (n.handleReturn = n.handleReturn.bind(d(n))),
          (n.handleTab = n.handleTab.bind(d(n))),
          (n.handleKeyPress = n.handleKeyPress.bind(d(n))),
          (n.handleSelectItem = n.handleSelectItem.bind(d(n))),
          (n.handleIndexChange = n.handleIndexChange.bind(d(n))),
          n
        );
      }
      r(t, e);
      ...
      return (
        ...
        (a.commitSelection = function(e) {
          this.setState({ activateIndex: e }), this.handleIndexChange(e);
        }),
        (a.activateMenuItem = function(e) {
          this.setState({ activateIndex: e }), this.handleIndexChange(e);
        }),
        ...
        (a.handleUpArrow = function(t) {
          var e = this.props.items;
          if (this.state.active) {
            t.preventDefault();
            var a = this.state.activateIndex - 1;
            0 > a && (a = e.length ? e.length - 1 : 0),
              this.activateMenuItem(a);
          }
        }),
        (a.handleDownArrow = function(t) {
          var e = this.props.items;
          if (this.state.active) {
            t.preventDefault();
            var a = this.state.activateIndex + 1;
        ...
        (a.handleTab = function(t) {
          this.state.active &&
            (t.preventDefault(),
            this.commitSelection(this.state.activateIndex));
        }),
        (a.handleReturn = function(t) {
          t.preventDefault(),
            this.state.active
              ? this.commitSelection(this.state.activateIndex)
              : this.setState({ active: !0 });
        }),
        (a.handleEscape = function() {
      ...
      return (
        (a.handleSelectItem = function(e) {
          var t = this.props,
            a = t.rates,
            n = t.actions;
          0 <= e && e < a.length && n.changeRate(a[e]);
        }),
        (a.render = function() {
          var e = this.props,
            t = e.rates,
            ...
            o = t.indexOf(a.playbackRate) || 0;
          return U.createElement(
            la,
            {
              className: Qe('video-react-playback-rate', this.props.className),
  ...
  (ia.propTypes = da),
    (ia.defaultProps = { rates: [2, 1.5, 1.25, 1, 0.5, 0.25] }),
    (ia.displayName = 'PlaybackRateMenuButton');
  var sa = {
      children: Je.any,
      autoHide: Je.bool,
      autoHideTime: Je.number,
      disableDefaultControls: Je.bool,
      disableCompletely: Je.bool,
      className: Je.string
    },
    ca = (function(e) {
      function t(t) {
        ...
        return (
          (a = e.call(this, t) || this),
          (a.getDefaultChildren = a.getDefaultChildren.bind(d(a))),
          (a.getFullChildren = a.getFullChildren.bind(d(a))),
          a
        );
      }
      r(t, e);
      var a = t.prototype;
      return (
        (a.getDefaultChildren = function() {
          return [
            U.createElement(It, { key: 'play-toggle', order: 1 }),
            U.createElement(ea, { key: 'volume-menu-button', order: 4 }),
            U.createElement(F, { key: 'current-time-display', order: 5.1 }),
            U.createElement(O, { key: 'time-divider', order: 5.2 }),
            U.createElement(L, { key: 'duration-display', order: 5.3 }),
            U.createElement(Rt, { key: 'progress-control', order: 6 }),
            U.createElement(jt, { key: 'fullscreen-toggle', order: 8 })
          ];
        }),
        (a.getFullChildren = function() {
          return [
            U.createElement(It, { key: 'play-toggle', order: 1 }),
            U.createElement(Bt, { key: 'replay-control', order: 2 }),
            U.createElement(_t, { key: 'forward-control', order: 3 }),
            U.createElement(ea, { key: 'volume-menu-button', order: 4 }),
            U.createElement(F, { key: 'current-time-display', order: 5 }),
            U.createElement(O, { key: 'time-divider', order: 6 }),
            U.createElement(L, { key: 'duration-display', order: 7 }),
            U.createElement(Rt, { key: 'progress-control', order: 8 }),
            U.createElement(I, { key: 'remaining-time-display', order: 9 }),
            U.createElement(ia, {
              rates: [1, 1.25, 1.5, 2],
              key: 'playback-rate',
              order: 10
            }),
            U.createElement(jt, { key: 'fullscreen-toggle', order: 11 })
          ];
        }),
  ...
  (ca.propTypes = sa),
    (ca.defaultProps = { autoHide: !0, disableCompletely: !1 }),
    (ca.displayName = 'ControlBar');
  var pa =
      'undefined' != typeof window && window.navigator
        ? window.navigator.userAgent
        : '',
    ua = /iPad/i.test(pa),
    ha = /iPhone/i.test(pa) && !ua,
    ma = /iPod/i.test(pa),
    va = {
      children: Je.any,
    ...
    ya = (function(e) {
      function t(t) {
        ...
        return (
          ...
          (a.video = null),
          (a.manager = new st(t.store)),
          (a.actions = a.manager.getActions()),
          a.manager.subscribeToPlayerStateChange(
            a.handleStateChange.bind(d(a))
          ),
          (a.getStyle = a.getStyle.bind(d(a))),
          (a.handleResize = a.handleResize.bind(d(a))),
          (a.getChildren = a.getChildren.bind(d(a))),
          (a.handleMouseMove = S(a.handleMouseMove.bind(d(a)), 250)),
          (a.handleMouseDown = a.handleMouseDown.bind(d(a))),
          (a.startControlsTimer = a.startControlsTimer.bind(d(a))),
          (a.handleFullScreenChange = a.handleFullScreenChange.bind(d(a))),
          (a.handleKeyDown = a.handleKeyDown.bind(d(a))),
          (a.handleFocus = a.handleFocus.bind(d(a))),
          (a.handleBlur = a.handleBlur.bind(d(a))),
          a
        );
      }
      r(t, e);
      ...
      return (
        (a.componentDidMount = function() {
          this.handleResize(),
            ...
            rt.addEventListener(this.handleFullScreenChange);
        }),
        (a.componentWillUnmount = function() {
          window.removeEventListener('resize', this.handleResize),
            rt.removeEventListener(this.handleFullScreenChange),
        ...
        (a.getDefaultChildren = function(e) {
          ...
          return [
            ...
            U.createElement(f, { key: 'poster-image', order: 1 }),
            U.createElement(E, { key: 'loading-spinner', order: 2 }),
            U.createElement(Ct, { key: 'bezel', order: 3 }),
            U.createElement(pt, { key: 'big-play-button', order: 4 }),
            U.createElement(ca, { key: 'control-bar', order: 5 }),
            U.createElement(Tt, { key: 'shortcut', order: 99 })
          ];
        }),
        (a.getChildren = function(e) {
          var t = e.className,
            ...
            o = U.Children.toArray(this.props.children).filter(function(t) {
              return !k(t);
            }),
            r = this.getDefaultChildren(a);
          return T(r, o, n);
        }),
        (a.setWidthOrHeight = function(e, t, a) {
          var n, o;
          'string' == typeof a
            ? 'auto' === a
              ? (o = 'auto')
        ...
        (a.getStyle = function() {
          ...
          return (
            ...
            (t = void 0 === l ? e * u : l),
            o
              ? this.setWidthOrHeight(c, 'height', '100%')
              : (this.setWidthOrHeight(c, 'width', e),
                this.setWidthOrHeight(c, 'height', t)),
            c
          );
        }),
        (a.getState = function() {
        ...
        (a.handleStateChange = function(e, t) {
          e.isFullscreen !== t.isFullscreen &&
            (this.handleResize(), M(this.manager.rootElement)),
            this.forceUpdate();
        }),
        (a.handleFocus = function() {
              ...
              className: Qe(
                {
                  ...
                  'video-react-workinghover': !(ha || ua || ma)
                },
                'video-react',
                this.props.className
              ),
  ...
  (ya.contextTypes = { store: Je.object }),
    (ya.propTypes = va),
    (ya.defaultProps = {
      fluid: !0,
      muted: !1,
  ...
  var ga = (function(e) {
    ...
    return (
      (a.render = function() {
        return U.createElement(ia, this.props);
      }),
      t
    );
  })(t.Component);
  ...
  var ba = {
    ...
    Ea = (function(e) {
      function t(t, a) {
        ...
        return (
          (n = e.call(this, t, a) || this),
          (n.getTextTrackItems = n.getTextTrackItems.bind(d(n))),
          (n.updateState = n.updateState.bind(d(n))),
          (n.handleSelectItem = n.handleSelectItem.bind(d(n))),
      ...
      return (
        ...
        (a.getTextTrackItems = function() {
          var e = this.props,
            ...
            r = a.textTracks,
            l = a.activeTextTrack,
            d = { items: [], selectedIndex: 0 },
            i = Array.from(r || []);
          return 0 === i.length
            ? d
            : (o && d.items.push({ label: n || 'Off', value: null }),
              i.forEach(function(e) {
                (t.length && !t.includes(e.kind)) ||
                  d.items.push({ label: e.label, value: e.language });
              }),
              (d.selectedIndex = d.items.findIndex(function(e) {
                return l && l.language === e.value;
              })),
              -1 === d.selectedIndex && (d.selectedIndex = 0),
              d);
        }),
        ...
        (a.textTrackItemsAreEqual = function(e, t) {
        ...
        (a.render = function() {
          ...
          return U.createElement(
            la,
            {
              className: Qe('video-react-closed-caption', this.props.className),
              onSelectItem: this.handleSelectItem,
              items: t,
              selectedIndex: a
            },
  ...
  (Ea.propTypes = ba),
    ...
    (Ea.displayName = 'ClosedCaptionButton'),
    (e.Bezel = Ct),
    (e.BigPlayButton = pt),
    (e.ClosedCaptionButton = Ea),
    (e.ControlBar = ca),
    (e.CurrentTimeDisplay = F),
    (e.DurationDisplay = L),
    (e.ForwardControl = _t),
    (e.FullscreenToggle = jt),
    (e.LoadProgressBar = R),
    (e.LoadingSpinner = E),
    (e.MenuButton = la),
    (e.MouseTimeDisplay = x),
    (e.PlayProgressBar = D),
    (e.PlayToggle = It),
    (e.PlaybackRate = ga),
    (e.PlaybackRateMenuButton = ia),
    (e.Player = ya),
    (e.PosterImage = f),
    (e.ProgressControl = Rt),
    (e.RemainingTimeDisplay = I),
    (e.ReplayControl = Bt),
    (e.SeekBar = wt),
    (e.Shortcut = Tt),
    (e.Slider = St),
    (e.TimeDivider = O),
    (e.Video = Et),
    (e.VolumeMenuButton = ea),
    (e.operationReducer = g),
    (e.playerActions = lt),
    (e.playerReducer = y),
    (e.videoActions = nt),
